...
class ModelCreator
{
     ...
     * @return string
     */
    public function create($keyName = 'id', $fields, $timestamps = true, $softDeletes = false)
    {
    ...
    public function getPath($name)
    {
        ...
        $path = app_path('Models/'.implode('/', $segments)).'.php';
    ...
    protected function replaceTable(&$stub, $name)
    {
        ...
        $table = Str::plural(strtolower($class)) !== $this->tableName ? "/**
     ...
     */
    protected \$fillable = [
        ".trim(implode(str_repeat(' ', 8), $rows), "\n")."
    ];\n\n";

        $stub = str_replace('DummyFillable', $string, $stub);
